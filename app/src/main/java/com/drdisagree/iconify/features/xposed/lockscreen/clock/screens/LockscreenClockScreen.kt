...
val lsClockPreferences = preferenceScreen {
    ...
    category {
        ...
        filePicker(
            ...
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) in setOf(26, 27, 30, 39, 40, 42, 53, 61) },
            isEnabled = { it.getBoolean(XposedKey.CUSTOM_LOCKSCREEN_CLOCK) }
        )
    ...
    category(
        title = stringRes(R.string.lockscreen_clock_61_constructor_title),
    ) {
        switch(
            key = XposedKey.LSCLOCK_61_SHOW_TIME_OVERLAY,
            title = stringRes(R.string.lockscreen_clock_61_show_time_overlay_title),
            summary = { stringRes(R.string.lockscreen_clock_61_show_time_overlay_desc) },
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
            isEnabled = { it.getBoolean(XposedKey.CUSTOM_LOCKSCREEN_CLOCK) }
        )

        slider(
            key = XposedKey.LSCLOCK_61_MEDIA_WIDTH,
            title = stringRes(R.string.lockscreen_clock_61_media_width_title),
            min = 120f,
            max = 360f,
        ...
        slider(
            key = XposedKey.LSCLOCK_61_MEDIA_HEIGHT,
            title = stringRes(R.string.lockscreen_clock_61_media_height_title),
            min = 120f,
            max = 420f,
            valueLabel = { "${it.roundToInt()}dp" },
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
        ...
        slider(
            key = XposedKey.LSCLOCK_61_MEDIA_TOP_MARGIN,
            title = stringRes(R.string.lockscreen_clock_61_media_top_margin_title),
            min = 0f,
            max = 120f,
            valueLabel = { "${it.roundToInt()}dp" },
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
        ...
        slider(
            key = XposedKey.LSCLOCK_61_IMAGE_OPACITY,
            title = stringRes(R.string.lockscreen_clock_61_image_opacity_title),
            min = 10f,
            max = 100f,
        ...
        listPref(
            key = XposedKey.LSCLOCK_61_IMAGE_SHAPE,
            title = stringRes(R.string.lockscreen_clock_61_image_shape_title),
            entries = arrayRes(R.array.lockscreen_clock_61_image_shape_entries),
            entryValues = arrayRes(R.array.lockscreen_clock_61_image_shape_values),
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
            isEnabled = { it.getBoolean(XposedKey.CUSTOM_LOCKSCREEN_CLOCK) }
        )

        slider(
            key = XposedKey.LSCLOCK_61_IMAGE_CORNER_RADIUS,
            title = stringRes(R.string.lockscreen_clock_61_image_corner_radius_title),
            min = 0f,
            max = 120f,
            valueLabel = { "${it.roundToInt()}dp" },
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
        ...
        slider(
            key = XposedKey.LSCLOCK_61_IMAGE_BORDER_WIDTH,
            title = stringRes(R.string.lockscreen_clock_61_image_border_width_title),
            min = 0f,
            max = 12f,
            valueLabel = { "${it.roundToInt()}dp" },
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
        ...
        listPref(
            key = XposedKey.LSCLOCK_61_IMAGE_SCALE_TYPE,
            title = stringRes(R.string.lockscreen_clock_61_image_scale_type_title),
            entries = arrayRes(R.array.lockscreen_clock_61_image_scale_type_entries),
            entryValues = arrayRes(R.array.lockscreen_clock_61_image_scale_type_values),
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
            isEnabled = { it.getBoolean(XposedKey.CUSTOM_LOCKSCREEN_CLOCK) }
        )

        slider(
            key = XposedKey.LSCLOCK_61_IMAGE_X_OFFSET,
            title = stringRes(R.string.lockscreen_clock_61_image_x_offset_title),
            min = -160f,
            max = 160f,
            valueLabel = { "${it.roundToInt()}dp" },
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
        ...
        slider(
            key = XposedKey.LSCLOCK_61_IMAGE_Y_OFFSET,
            title = stringRes(R.string.lockscreen_clock_61_image_y_offset_title),
            min = -160f,
            max = 160f,
            valueLabel = { "${it.roundToInt()}dp" },
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
        ...
        listPref(
            key = XposedKey.LSCLOCK_61_TIME_POSITION,
            title = stringRes(R.string.lockscreen_clock_61_time_position_title),
            entries = arrayRes(R.array.lockscreen_clock_61_time_position_entries),
            entryValues = arrayRes(R.array.lockscreen_clock_61_time_position_values),
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
            isEnabled = { it.getBoolean(XposedKey.CUSTOM_LOCKSCREEN_CLOCK) }
        )

        listPref(
            key = XposedKey.LSCLOCK_61_DATE_POSITION,
            title = stringRes(R.string.lockscreen_clock_61_date_position_title),
            entries = arrayRes(R.array.lockscreen_clock_61_date_position_entries),
            entryValues = arrayRes(R.array.lockscreen_clock_61_date_position_values),
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
            isEnabled = { it.getBoolean(XposedKey.CUSTOM_LOCKSCREEN_CLOCK) }
        )

        slider(
            key = XposedKey.LSCLOCK_61_DATE_X_OFFSET,
            title = stringRes(R.string.lockscreen_clock_61_date_x_offset_title),
            min = -160f,
            max = 160f,
            valueLabel = { "${it.roundToInt()}dp" },
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
        ...
        slider(
            key = XposedKey.LSCLOCK_61_DATE_Y_OFFSET,
            title = stringRes(R.string.lockscreen_clock_61_date_y_offset_title),
            min = -160f,
            max = 160f,
            valueLabel = { "${it.roundToInt()}dp" },
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
        ...
        slider(
            key = XposedKey.LSCLOCK_61_TIME_X_OFFSET,
            title = stringRes(R.string.lockscreen_clock_61_time_x_offset_title),
            min = -160f,
            max = 160f,
            valueLabel = { "${it.roundToInt()}dp" },
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
        ...
        slider(
            key = XposedKey.LSCLOCK_61_TIME_Y_OFFSET,
            title = stringRes(R.string.lockscreen_clock_61_time_y_offset_title),
            min = -160f,
            max = 160f,
            valueLabel = { "${it.roundToInt()}dp" },
            isVisible = { it.getInt(XposedKey.LSCLOCK_STYLE) == 61 },
